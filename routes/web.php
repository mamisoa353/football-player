...
Route::get('/joueur/{id}', [JoueurController::class, 'details']);
Route::get('/joueur/page/{id}', [JoueurController::class, 'detailJoueurPage']);
Route::auto('/parcours', ParcoursController::class);
